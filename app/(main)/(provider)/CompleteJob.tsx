...
const CompleteJob = () => {
    ...
    const handleContinue = () => {
        ...
        if (code.length === 4) {
            ...
            router.push("/success?title=Job Successfully Done!&description=You job has been completed successfully, Great Job...")
        }
    };
    ...
    return (
        <Container appBar appBarTitle="" containerProps={{ centerH: true }}>
            ...
            <Text gray regular center marginT-12 style={{ lineHeight: moderateScale(22) }}>
                Please enter the verification code that the user has received to complete the Job
            </Text>
